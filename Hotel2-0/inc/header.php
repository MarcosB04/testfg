...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">~BELLAVISTA~</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-2" href="Rooms.php">Habitaciones</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="Facilities.php">Servicios</a>
        </li>
        <li class="nav-item">
       ...
       <div class="d-flex" role="search">
        ...
        <button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal" data-bs-target="#registermodel">Registrarse</button>
       </div>
    </div>
  </div>
</nav>
       ...
       <form action="">
        ...
        <div class="modal-body">
         ...
         <div class="d-flex align-items-center justify-content-between mb-2">
          ...
          <a href="javascript: void(0)" class="text-secoundary text-decoration-none" >¿Olvidaste tu contraseña?</a>
         </div>
        </div>
      </form>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form action="">
          ...
          <div class="modal-body">
            <span class="badge rounded-pill text-bg-light mb-3 text-wrap ls-base">Nota: Sus detalles deben coincidir con la identificación (DNI, pasaporte, licencia de conducir, etc.) que se requerirá durante el registro.</span>
            <div class="container-fluid">
              <div class="row">
